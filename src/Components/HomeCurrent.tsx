...
function HomeCurrentWeather() {
  ...
  useEffect(() => {
    if (locationData.locationData.locations.length > 0) { //if there is already stored locationdata then use it for the api call
      const { lat, lng } = locationData.locationData.locations[0];
